...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "8119260776:AAGGaMVepLxfs3dRtNeFLy-LqCfbrYaMFms")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "url_bds_bot") # Bot username without @.
